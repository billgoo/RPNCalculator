...
public class OperatorTest {
    ...
    public void testCalculate() throws CalculatorException {
        ...
        assertEquals(pow(firstOperand, 2.0), Operator.SQUARE.calculate(firstOperand, null), 0);
        assertEquals(sqrt(secondOperand), Operator.SQRT.calculate(secondOperand, null), 0);
    }
